 ...
 *
 */
@ASNTag(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 91,constructed = true,lengthIndefinite = false)
public class ATCFRecord 
{
	...
	public ATCFRecord(RecordType recordType, boolean retransmission, String sipMethod,
			...
			byte[] routeHeaderReceived, byte[] routeHeaderTransmitted,
